...
var LoginPage = (function () {
    function LoginPage(nav, auth, alertCtrl, loadingCtrl) {
        ...
        this.registerCredentials = { username: 'Lucien', password: 'lulu' };
    }
...
var AlarmPage = (function () {
    function AlarmPage(alertCtrl, dataProvider) {
        ...
        this.dataProvider.getAlarmData().subscribe(function (data) {
            _this.alarmInfo = _this.dataProvider.alarmData;
    ...
    AlarmPage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__providers_data_data__["a" /* DataProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__providers_data_data__["a" /* DataProvider */]) === "function" && _b || Object])
    ], AlarmPage);
    return AlarmPage;
    var _a, _b;
}());
...
var HomePage = (function () {
    ...
    function HomePage(navCtrl, dataProvider) {
        ...
        this.dataProvider.getWeatherList().subscribe(function (data) {
            _this.weatherList = _this.dataProvider.weatherData;
            //this.todayWeather = this.weatherList[0];
            //this.weatherList = this.weatherList.slice(1);
    ...
    HomePage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__providers_data_data__["a" /* DataProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__providers_data_data__["a" /* DataProvider */]) === "function" && _b || Object])
    ], HomePage);
    return HomePage;
    var _a, _b;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_mergeMap__ = __webpack_require__(410);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_mergeMap___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_mergeMap__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_observable_fromPromise__ = __webpack_require__(412);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_observable_of__ = __webpack_require__(413);
...
var DataProvider = (function () {
    ...
    DataProvider.prototype.getWeatherList = function () {
        var _this = this;
        return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].create(function (observer) {
            _this.http.get("https://wealarapi.herokuapp.com/data/weather", _this.httpOptions)
                .subscribe(function (val) {
                _this.weatherData = val.data.weather;
                observer.next(true);
                console.log("POST call successful value returned in body", val);
                console.log("WeatherData", _this.weatherData);
            }, function (response) {
                console.log("POST call in error", response);
                observer.next(true);
            }, function () {
    ...
    DataProvider.prototype.getAlarmData = function () {
        var _this = this;
        return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].create(function (observer) {
            _this.http.get("https://wealarapi.herokuapp.com/data/alarm", _this.httpOptions)
                .subscribe(function (val) {
                _this.alarmData = val.data.alarm;
                observer.next(true);
                console.log("POST call successful value returned in body", val);
                console.log("WeatherData", _this.alarmData);
            }, function (response) {
                console.log("POST call in error", response);
                observer.next(true);
            }, function () {
